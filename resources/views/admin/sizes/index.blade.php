                ...
                <div class="modal-body">
                    <form class="form-horizontal" role="form">
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="title" name="size">Size:</label>
                            <div class="col-sm-10">
                                <input type="number" class="form-control" id="size"  name="size" autofocus>
  ...
  <script>
        ...
        $(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if ((data.errors)) {
                            ...
                            //     $('.errorCode').text(data.errors.description);
                            // }
                        } else {
            ...
            $(document).on('click', '.show-modal', function() {
                ...
                var url = '{{ asset('admin/size') }}'+'/' + id +'/anydataListProduct';
            ...
            $(document).on('click', '.edit-modal', function() {
                ...
                var id = $(this).attr('data-id');
                console.log(id);
                var url = '{{ asset('admin/size/edit') }}'+'/' + id;
                ...
                $('.modal-footer').on('click', '.edit', function() {
                    var url = '{{ asset('admin/size/update') }}'+'/' + id;
                    $.ajax({
                        type: 'POST',
                        url: url,
                        data: {
            ...
            $('#color-table').on('click', '.delete', function(e){
             ...
             $('#color-table').on('click', '.btn-danger', function(e){
                e.preventDefault();
                var id = $(this).attr('data-id');
                var url = '{{ asset('admin/size/delete') }}'+'/' + id;
                swal({
                  dangerMode: true,
