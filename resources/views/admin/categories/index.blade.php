                       ...
                       {{--  --}}
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                class="ckeditor"  data-error="Please enter description."></textarea> --}}
...
@section('footer.js')
	...
	<script>
        ...
        $(function() {
            ...
            $('#category-table').on('click', '.btn-detail', function(e){
                 e.preventDefault();
            })

            var colorTable = $('#category-table').DataTable({
                processing: true,
                serverSide: true,
            ...
            $(document).on('click', '.show-modal', function() {
                ...
                var url = '{{ asset('admin/category') }}'+'/' + id +'/anydataListProduct';
            ...
            $(document).on('click', '.edit-modal', function() {
                ...
                var url = '{{ asset('admin/category/edit') }}'+'/' + id;
