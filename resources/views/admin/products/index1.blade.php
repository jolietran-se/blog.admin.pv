...
<datalist id="list_colors">
    ...
    <a class="btn btn-lg btn-info add-modal btn-xs" style="margin-bottom: 30px" href="" data-toggle="modal" data-target="#create-item"><span class="glyphicon glyphicon-plus"></a>

    <div id="modal_add_abc" class="modal fade" role="dialog">
        <div class="modal-dialog" style="width: 1100px">
            <div class="modal-content">
                <div class="modal-header modal-size">
    ...
    <script>
        $(function() {
            ...
            $('.modal-footer').on('click', '.add', function() {
                ...
                newPost.append('content',CKEDITOR.instances["editor1"]. ());
