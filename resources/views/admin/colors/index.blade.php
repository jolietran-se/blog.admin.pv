                ...
                <div class="modal-body">
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group" id="myColorPalette" >
                          ...
                          <div class="col-sm-10">
                             <input id="color" class="form-control" type="color" placeholder="Click to select a color">
                          </div>
  ...
  <script>
        ...
        $(function() {
            ...
            $(document).on('click', '.show-modal', function() {
                ...
                var url = '{{ asset('admin/color') }}'+'/' + id +'/anydataListProduct';
            ...
            $(document).on('click', '.edit-modal', function() {
                ...
                var id = $(this).attr('data-id');
                console.log(id);
                var url = '{{ asset('admin/color/edit') }}'+'/' + id;
                ...
                $('.modal-footer').on('click', '.edit', function() {
                    var url = '{{ asset('admin/color/update') }}'+'/' + id;
                    $.ajax({
                        type: 'POST',
                        url: url,
                        data: {
            ...
            $('#color-table').on('click', '.delete', function(e){
             ...
             $('#color-table').on('click', '.btn-danger', function(e){
                e.preventDefault();
                var id = $(this).attr('data-id');
                var url = '{{ asset('admin/color/delete') }}'+'/' + id;
                swal({
                  dangerMode: true,
